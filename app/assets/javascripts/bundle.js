...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  var mainEl = document.getElementById("react-container");
	
	  _react2.default.render(_react2.default.createElement(_search2.default, null), mainEl);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } // This component displays the results from the ajax request.
	...
	var SearchSpecies = function (_React$Component) {
	  _inherits(SearchSpecies, _React$Component);
	
	  function SearchSpecies(_ref) {
	    var species = _ref.species;
	
	    _classCallCheck(this, SearchSpecies);
	
	    //Executes React.Component's constructor method, if any, with the passed in props.
	
	    var _this = _possibleConstructorReturn(this, (SearchSpecies.__proto__ || Object.getPrototypeOf(SearchSpecies)).call(this, species)); //Deconstructing the props object, assuming it only contains species
	
	
	    _this.displayedShipmentDate = _this.displayedShipmentDate.bind(_this);
	    return _this;
	  }
	
	  _createClass(SearchSpecies, [{
	    key: 'displayedShipmentDate',
	    value: function displayedShipmentDate(inventory, shipmentDate) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          { 'class': 'species-list' },
	          (0, _lodash.keys)(species).map(function (speciesId) {
	            return _react2.default.createElement(
	              'li',
	              { 'class': 'species-list', key: speciesId },
	              _react2.default.createElement(
	                'div',
	                { 'class': 'speciesInfo' },
	                speciesId
	              ...
	              _react2.default.createElement(
	                'div',
	                { 'class': 'speciesInfo' },
	                species[speciesId].latin_name
	              ),
	              _react2.default.createElement(
	                'div',
	                { 'class': 'speciesInfo' },
	                species[speciesId].country_name
	              ),
	              _react2.default.createElement(
	                'div',
	                { 'class': 'speciesInfo' },
	                _this2.displayedShipmentDate(species[speciesId].inventory_count, species[speciesId].next_shipment_date)
	              )
	            );
	          })
	        )
